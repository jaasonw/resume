...
\textbf{Libraries/Frameworks}: Bootstrap, Flask, Flutter, Node.js, NumPy, React (Next.js)\\
\textbf{Tools/Software}: git, Unix/Linux, AWS, Google Cloud Platform, PostgreSQL, SQLite
\\
\section*{Projects}
