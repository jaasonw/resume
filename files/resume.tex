...
\textbf{Backend/DevOps}: Express.js, Flask, Node.js, Docker, PostgreSQL, SQLite, MySQL, NGINX
\section*{Experience}
...
\begin{itemize}
    ...
    \item Replaced the Firestore database with a PostgreSQL database allowing us to scale to our 300 user target while reducing our effective hosting costs to \$0
...
\begin{itemize}
    ...
    \item Designed the SQLite database allowing for per user error logging, token storage, and playlist caching, minimizing API calls
\end{itemize}
