...
\section*{Education}
\resumesection{California State University, Fullerton}{}{Computer Science, B.S. \& Minor in Mathematics, Expected 2022}
\begin{itemize}
    \item \textbf{Coursework}: File Structures \& Database Systems, Computer Organization
\end{itemize}
\resumesection{Pasadena City College}{}{Mathematics, AS-T, 2020}
\begin{itemize}
    \item \textbf{Coursework}: Data Structures, Unix Scripting, Discrete Mathematics
\end{itemize}
\hfill
\section*{Skills}
...
\\
\section*{Projects}
\resumesection{Spotify Seasonal Playlist Sorter | Python}{Developer}{April 2020}
\begin{itemize}
...
\resumesection{APPE Regional Draft Analysis | Python}{Developer}{January 2021}
\begin{itemize}
    \item Monte Carlo simulation to forecast the probability of 
        pharmacy students getting their preferred region for their APPE rotations
\end{itemize}

\resumesection{SQL Relational Database System | C++}{Developer}{June 2019}
\begin{itemize}
...
\resumesection{Sushi Shop | Java}{Developer}{May 2017}
\begin{itemize}
