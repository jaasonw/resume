...
\begin{itemize}
    \item Design and develop complex systems that create high confidence "golden datasets"
    \item Train, analyze, and improve model performance resulting in less developer overhead and reduced data labeling costs
...
\begin{itemize}
    ...
    \item Mentor budding developers by providing useful documentation and pointers
\end{itemize}
\resumesection{TuffyHacks 2022}{Website Developer}{September 2021 - February 2022}
\begin{itemize}
    \item Built mobile responsive web frontends, specifically the landing page, promoting the event to thousands of students, and the dashboard, facilitating team creation and displaying live event announcements
