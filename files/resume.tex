...
\resumesection{Nex-ii LLC, Twiine}{Project Manager / Developer}{June 2020 - Present}
\begin{itemize}
    ...
    \item Oversaw the development of the mobile app and implemented major components and functionality
    \item Designed and implemented parts of the backend API with Node.js deployed on Firebase Cloud Functions
    \item Structured and maintained the Firestore database to fit the needs of the app and website
\end{itemize}
...
\hfill
\section*{Skills}
\textbf{Languages}: C++, Python, Java, JavaScript/TypeScript, HTML/CSS, {\fontfamily{lmr}\selectfont\LaTeX}, bash, Dart\\
