...
\begin{itemize}
    \item \textbf{Degree}: Computer Science BS (Expected 2022)
\end{itemize}
\hfill
\section*{Projects}
...
\begin{itemize}
    ...
    \item Implemented the shunting yard algorithm to parse mathematical expressions to postfix notation
...
\resumesection{PCC Learning Assistance Center, Pasadena}{Tutor / Lab TA}{January 2019 - Present}
\begin{itemize}
