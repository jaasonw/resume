...
\begin{itemize}
    ...
    \item Designed and implemented parts of the backend API
\end{itemize}
...
\hfill
\section*{Skills}
\textbf{Languages}: C++, Python, Java, JavaScript/TypeScript, HTML/CSS, {\fontfamily{cmr}\selectfont\LaTeX}, bash, Dart\\
