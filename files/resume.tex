...
\begin{itemize}
    ...
    \item \textbf{Coursework}: Databases
\end{itemize}
...
\hfill
\section*{Skills}
\textbf{Languages}: C++, Python, Java, JavaScript/TypeScript, HTML/CSS, {\fontfamily{lmr}\selectfont\LaTeX}, Dart, x86 Assembly\\
\textbf{Libraries/Frameworks}: Bootstrap, Flask, Node.js, Flutter\\
\textbf{Tools/Software}: git, Unix/Linux, AWS, Google Cloud Platform (Firebase)
\\
\section*{Work Experience}
\resumesection{Nex-ii LLC, Twiine}{Full Stack Developer, twiine.com}{June 2020 - September 2020}
\begin{itemize}
    \item Built a hangouts planning and user profile page with support for realtime updates from the database
...
\begin{itemize}
    ...
    \item Assisted and advised staff and administrators on the transition to remote tutoring during the COVID-19 Pandemic
\end{itemize}
\hfill
\section*{Projects}
