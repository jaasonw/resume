...
\begin{itemize}
    ...
    \item Trained the classifier on a dataset of labeled emails, achieving a precision of 98.2\% and a recall of 97.3\% on the testing dataset using the Naive Bayes Classifier
\end{itemize}
