...
\resumesection{Nex-ii}{Developer, Twiine}{June 2020 - Present}
\begin{itemize}
    \item Project manager of mobile application development
    \item Implemented major components and functionality of the mobile app
    \item Worked with frontend and backend teams to structure the NoSQL database to minimize querying
