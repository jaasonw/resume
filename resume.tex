...
\begin{itemize}
    ...
    \item Spearheaded the creation of a mobile-responsive frontend using \textbf{React (Next.js)} for TuffyHacks, an MLH-sponsored hackathon, featuring an impactful landing page that reached and engaged a global audience of thousands of students and a dashboard that facilitated team formation and showcased real-time event updates and announcements
...
% \end{itemize}
\resumesection{SWEify}{Javascript, Python, FastAPI, Scrapy, Next.js, React, TailwindCSS}{}
\begin{itemize}
...
\resumesection{Spotify Seasonal Playlist Creator}{Javascript, Python, Flask, Spotify REST API, Next.js, Docker Compose, NGINX}{}
\begin{itemize}
