...
\begin{itemize}
    \item Manage operations and configuration of a \textbf{Corelation Keystone} financial core, developing programs and scripts to automate routines and batch transaction postings
    \item Develop custom reports and dashboards in \textbf{Jaspersoft} to provide insights on member activity, loan performance, and operational metrics
    \item Develop mobile banking alerts and notifications service with \textbf{Python}, allowing members to receive real-time updates on card activity
    \item Serve as technical lead on loan preapproval campaign, coordinating with credit bureaus and internal teams to generate personalized preapproval offers for members
    \item Oversee critical IT infrastructure components including site-to-site VPN administration, and SAN replication
    \item Administer and maintain \textbf{Active Directory} and \textbf{Azure AD (Microsoft Entra)} environments, including user and group policy management
...
\textbf{Web}: React, Next.js, Svelte, Figma, TailwindCSS, Express.js, Flask, FastAPI, Node.js, PostgreSQL, SQLite, MySQL, IBM DB2, IBM AIX\\
...
\textbf{Certifications}: AHA First Aid CPR AED, CCNA 200-301 (WIP)\\
