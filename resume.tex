...
\begin{itemize}
    \item Manage operations and configuration of a hybrid on-premises and cloud infrastructure, ensuring high availability and security for a financial institution managing \$2.5B in assets
    ...
    \item Develop Email and SMS alerts service to notify members when card transactions are made
    \item Build tooling to migrate from financial core from Finastra Ultradata to Corelation Keystone
    \item Design, develop, and maintain \textbf{SQL}-based reports to provide insights for stakeholders across departments
...
\end{itemize}
% \resumesection{Software Engineer}{Hack for LA}{September 2023 - Present}
% \begin{itemize}
%     \item Develop routes and \textbf{React} components for the 311-Data project, a web app that allows users to view and analyze service request data
...
\begin{itemize}
    ...
    \item Spearhead the creation of mobile-responsive frontend using \textbf{Next.js} for \textbf{TuffyHacks}, a student-run, MLH-sponsored hackathon, featuring a landing page reaching and engaging a global audience of thousands of students and a dashboard that facilitated team formation and showcased real-time event updates and announcements
    \item Architect backend infrastructure, leveraging \textbf{AWS Lambda} functions and a \textbf{PostgreSQL} database, enabling participants to establish and join teams through personalized invite links, achieving zero downtime and minimizing latency, amidst peak traffic from hundreds of users whilst staying within free tier constraints
...
\begin{itemize}
    \item Spearhead the development of the Minimum Viable Product (MVP) for a date and hangout planning mobile app using \textbf{Flutter}
    \item Design and implement key app features, including the planning and user profile views, incorporating real-time updates for request acceptances and profile changes
    \item Orchestrate seamless user experience by crafting a secure and efficient login and signup flow, integrating \textbf{OpenID} and \textbf{OAuth} protocols for streamlined authentication via Google, Facebook, and Email
