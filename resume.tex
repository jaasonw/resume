...
\begin{itemize}
	...
	\item Develop \textbf{ETL pipeline} to scrape and transform data from multiple job boards into a SQL database
	\item Automatically parse and extract relevant information like technologies and years of experience using \textbf{Scrapy} and \textbf{BeautifulSoup} to filter out irrelevant listings like non-technical positions and senior roles
