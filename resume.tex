...
\begin{itemize}
    \item Manage operations and configuration of server infrastructure, ensuring a secure and high-performance hybrid cloud environment
    \item Monitor network performance and troubleshoot network outages, minimizing downtime and ensuring high availability
    \item Configure and maintain network security systems, including firewalls, intrusion detection systems, and VPNs to protect sensitive data, ensuring compliance with industry standards and regulations
    \item Administer and maintain \textbf{Active Directory} and \textbf{Azure AD} environments, including user and group management, and group policy
    ...
    \item Develop automations with \textbf{Python} and \textbf{Windows Powershell} to streamline and optimize IT operations, including user provisioning and deprovisioning, workstation and server configuration, and software installation
...
\begin{itemize}
    ...
    \item Spearheaded the creation of a mobile-responsive frontend using \textbf{React (Next.js)} for \textbf{TuffyHacks}, a student-run, MLH-sponsored hackathon, featuring an impactful landing page that reached and engaged a global audience of thousands of students and a dashboard that facilitated team formation and showcased real-time event updates and announcements
